...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2014/11/14 11:36:30 by alaulom           #+#    #+#              #
#    Updated: 2014/11/14 16:09:24 by alaulom          ###   ########.fr        #
#                                                                              #
#******************************************************************************#

NAME = libft.a

SRC =	ft_memcmp.c ft_strlen.c ft_strcpy.c ft_strncpy.c ft_strcmp.c \
	ft_strncmp.c ft_atoi.c ft_strcat.c ft_strdup.c ft_strchr.c ft_strcchr.c \
	ft_strncat.c ft_strlcat.c ft_strstr.c ft_strnstr.c ft_isalpha.c \
	ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_islower.c \
	ft_toupper.c ft_isupper.c ft_tolower.c ft_memalloc.c ft_memdel.c \
